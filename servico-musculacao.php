<html>
	<head>
		...
		<meta name="description" content="Monstros - Musculação!">
				...
				<div id="contato" class="row">
						<div class="col-md-12">
							...
							<div class="row">
									...
									<div class="col-md-6">
											<div id="carouselM" class="carousel slide" data-ride="carousel">
													...
													<div class="carousel-item active">
														<img class="d-block w-100" src="imgs/musculacao.jpg" alt="First slide">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" src="imgs/crosfit.jpg" alt="Second slide">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" src="imgs/pilates.jpg" alt="Third slide">
